...
export default function App() {
      ...
      signUp: async (data) => {
        ...
        try {
          const promise1 = axios.post(
            "https://lawbud-backend.onrender.com/user/addUser",
            data
          );
          // .then(()=>{
          ...
          const promise2 = createUserWithEmailAndPassword(
            auth,
            data.email_id,
            data.contact
          );
          ...
          Promise.all([promise1, promise2])
            .then((responses) => {
              if (responses[0].status == 200 && responses[1].status == 200) {
                ...
                // getAuth().getUserByEmail(data.email_id).then(( userRecord )=>{
  ...
  //   getAuth()
  // .getUserByEmail("dnyaneshbachhav2002@gmail.com")
  // .then((userRecord) => {
