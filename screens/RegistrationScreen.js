...
function RegistrationScreen() {
  ...
  const { usersType, setUsersType, newUserData, setNewUserData1 } =
  ...
  return (
    <View style={styles.container}>
      ...
      <Register
        userType={userType}
        State={State}
        usersType={State.usersType}
        setUserType={setUserType}
        setUsersType={State.setUsersType}
        setNewUserData1={State.updateUser}
...
function Register({
  ...
  useEffect(() => {
    if (email !== null && phone !== null) notifyData();
        ...
        onSubmit={(state) => {
          ...
          if (state.email !== null && state.phone !== null) {
            ...
            State.updateUser({
              ...newUserData,
              email_id: email1,
              contact: parseInt(phone1),
              type: State.usersType,
            });
          }
          sendVerification(state.phone);
        }}
