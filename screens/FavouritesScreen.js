...
function FavouritesScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      {
        favouritesData == null ? <Text>No user data...</Text> : null
      }
      {favouritesData && (
        <FlatList
          data={favouritesData}
          ...
          renderItem={({ item, index }) => (
            ...
            <Card
              name={item?.name}
              type={item?.type}
              languages={item?.languages || ["Marathi", "Hindi", "English"]}
          ...
          <View style={{ flex: 1, marginLeft: 10, justifyContent: "center" }}>
            ...
            >
              ...
              <View style={{ flexDirection: "row" }}>
                <TouchableOpacity>
                  <AntDesign name="staro" size={20} color={COLORS.gray} />
                </TouchableOpacity>
                <TouchableOpacity>
                  <AntDesign name="staro" size={20} color={COLORS.gray} />
                </TouchableOpacity>
